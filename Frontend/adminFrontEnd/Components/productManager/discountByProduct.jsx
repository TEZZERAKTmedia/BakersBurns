...
import { useProductContext } from '../Components/productManager/ProductsContext'; // Import the context

const DiscountByProductForm = ({ productId, onClose, onSuccess }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      // Use the applyDiscount function from the context
      ...
      if (onSuccess) {
        onSuccess(response); // Call the onSuccess callback if provided
      }
